...
# Session appears in agent-desk, ready to continue
```
...
Import a shared session file and create an agent-desk session:
...
1. Working in agent-desk session on a feature
...
3. Session appears in agent-desk as "Imported: feature"
...
| Issue | Solution |
|-------|----------|
| "Could not detect current Claude session" | Make sure you're in an agent-desk session with active Claude |
