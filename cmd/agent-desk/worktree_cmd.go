...
func printWorktreeUsage() {
	fmt.Println("Usage: agent-desk worktree <command> [options]")
	fmt.Println()
	...
	fmt.Println("  agent-desk worktree list")
	fmt.Println("  agent-desk worktree list --json")
	fmt.Println("  agent-desk worktree info \"My Session\"")
	fmt.Println("  agent-desk worktree finish \"My Session\"")
	fmt.Println("  agent-desk worktree finish \"My Session\" --no-merge")
	fmt.Println("  agent-desk worktree finish \"My Session\" --into develop")
	fmt.Println("  agent-desk worktree cleanup")
	fmt.Println("  agent-desk worktree cleanup --force")
}
...
func handleWorktreeList(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk worktree list [options]")
		fmt.Println()
...
func handleWorktreeInfo(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk worktree info <session> [options]")
		fmt.Println()
...
func handleWorktreeCleanup(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk worktree cleanup [options]")
		fmt.Println()
...
func handleWorktreeFinish(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk worktree finish <session> [options]")
		fmt.Println()
		...
		fmt.Println()
		fmt.Println("Examples:")
		fmt.Println("  agent-desk worktree finish \"My Feature\"")
		fmt.Println("  agent-desk worktree finish \"My Feature\" --into develop")
		fmt.Println("  agent-desk worktree finish \"My Feature\" --no-merge")
		fmt.Println("  agent-desk worktree finish \"My Feature\" --no-merge --force")
	}
	...
	// Step 5: Remove session from agent-desk
	var remaining []*session.Instance
