...
func printGroupHelp() {
	fmt.Println("Usage: agent-desk group <command> [options]")
	fmt.Println()
	...
	fmt.Println("  agent-desk group list")
	fmt.Println("  agent-desk group create mobile")
	fmt.Println("  agent-desk group create ios --parent mobile")
	fmt.Println("  agent-desk group delete experiments")
	fmt.Println("  agent-desk group delete work --force")
	fmt.Println("  agent-desk group move my-project work/frontend")
	fmt.Println("  agent-desk group move my-project \"\"          # Move to root")
}
...
func handleGroupList(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk group list [options]")
		fmt.Println()
...
func handleGroupCreate(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk group create <name> [options]")
		fmt.Println()
	...
	if name == "" {
		...
		fmt.Println("Usage: agent-desk group create <name> [--parent <group>]")
		os.Exit(1)
	}
...
func handleGroupDelete(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk group delete <name> [options]")
		fmt.Println()
		...
		fmt.Println("Examples:")
		fmt.Println("  agent-desk group delete experiments")
		fmt.Println("  agent-desk group delete work --force   # Move sessions to parent")
	}
	...
	if name == "" {
		out.Error("group name is required", ErrCodeNotFound)
		fmt.Println("Usage: agent-desk group delete <name> [--force]")
		os.Exit(1)
	}
...
func handleGroupMove(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk group move <session-id> <group>")
		fmt.Println()
		...
		fmt.Println("  agent-desk group move my-project work/frontend")
		fmt.Println("  agent-desk group move my-project \"\"              # Move to root")
		fmt.Println("  agent-desk group move my-project root            # Move to root")
	}
