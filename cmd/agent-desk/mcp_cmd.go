...
func printMCPHelp() {
	fmt.Println("Usage: agent-desk mcp <command> [options]")
	fmt.Println()
	...
	fmt.Println("  agent-desk mcp list                        # List available MCPs")
	fmt.Println("  agent-desk mcp attached                    # Show MCPs for current session")
	fmt.Println("  agent-desk mcp attached my-project         # Show MCPs for specific session")
	fmt.Println("  agent-desk mcp attach my-project exa       # Attach exa to my-project (local)")
	fmt.Println("  agent-desk mcp attach my-project exa --global     # Attach globally")
	fmt.Println("  agent-desk mcp detach my-project exa       # Detach exa from my-project")
	fmt.Println("  agent-desk mcp server status               # Show HTTP server status")
	fmt.Println("  agent-desk mcp server start slack          # Start HTTP server for slack MCP")
}
...
func handleMCPList(args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk mcp list [options]")
		fmt.Println()
	...
	if len(mcps) == 0 {
		if *jsonOutput {
			...
			fmt.Println()
			fmt.Println("Define MCPs in ~/.agent-desk/config.toml:")
			fmt.Println()
...
func handleMCPAttached(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk mcp attached [session-id] [options]")
		fmt.Println()
...
func handleMCPAttach(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk mcp attach <session-id> <mcp-name> [options]")
		fmt.Println()
		...
		fmt.Println()
		fmt.Println("Examples:")
		fmt.Println("  agent-desk mcp attach my-project exa           # Attach locally")
		fmt.Println("  agent-desk mcp attach my-project exa --global  # Attach globally")
		fmt.Println("  agent-desk mcp attach my-project exa --restart # Attach and restart")
	}
	...
	if fs.NArg() < 2 {
		...
		if !*jsonOutput {
			fmt.Println("\nUsage: agent-desk mcp attach <session-id> <mcp-name> [options]")
		}
		os.Exit(1)
	}
...
func handleMCPDetach(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk mcp detach <session-id> <mcp-name> [options]")
		fmt.Println()
		...
		fmt.Println()
		fmt.Println("Examples:")
		fmt.Println("  agent-desk mcp detach my-project exa           # Detach from local")
		fmt.Println("  agent-desk mcp detach my-project exa --global  # Detach from global")
		fmt.Println("  agent-desk mcp detach my-project exa --restart # Detach and restart")
	}
	...
	if fs.NArg() < 2 {
		out.Error("session ID and MCP name are required", ErrCodeInvalidOperation)
		if !*jsonOutput {
			fmt.Println("\nUsage: agent-desk mcp detach <session-id> <mcp-name> [options]")
		}
		os.Exit(1)
	}
...
func printMCPServerHelp() {
	fmt.Println("Usage: agent-desk mcp server <command> [options]")
	fmt.Println()
	...
	fmt.Println()
	fmt.Println("Examples:")
	fmt.Println("  agent-desk mcp server status              # Show all HTTP server status")
	fmt.Println("  agent-desk mcp server status slack        # Show slack server status")
	fmt.Println("  agent-desk mcp server start slack         # Start slack HTTP server")
	fmt.Println("  agent-desk mcp server stop slack          # Stop slack HTTP server")
}
...
func handleMCPServerStart(args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk mcp server start <mcp-name>")
		fmt.Println()
...
func handleMCPServerStop(args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk mcp server stop <mcp-name>")
		fmt.Println()
...
func handleMCPServerStatus(args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk mcp server status [mcp-name]")
		fmt.Println()
