...
import (
	...
	"github.com/millwright-software/agent-desk/internal/experiments"
...
func handleTry(profile string, args []string) {
	...
	fs.Usage = func() {
		fmt.Println("Usage: agent-desk try <name> [options]")
		fmt.Println()
		...
		fmt.Println("  agent-desk try redis-cache          # Create/find redis-cache experiment")
		fmt.Println("  agent-desk try rds                  # Fuzzy match 'redis-cache'")
		fmt.Println("  agent-desk try --list               # List all experiments")
		fmt.Println("  agent-desk try --list redis         # Fuzzy search experiments")
		fmt.Println("  agent-desk try myproject -c gemini  # Use Gemini instead of Claude")
		fmt.Println("  agent-desk try myproject --no-session  # Just create folder")
		fmt.Println()
		fmt.Println("Config (~/.agent-desk/config.toml):")
